...
public class TupleDesc implements Serializable {
    ...
    public int fieldNameToIndex(String name) throws NoSuchElementException {
        ...
        throw new NoSunchElementException("No name-matched field");
    }
    ...
    public int getSize() {
        ...
        while (itr.hasnext()){
            TDItem now;
            now = itr.next();
            totalsize += now.fieldType.getLen();
        }
        return 0;
    }
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        // some code goes here
        int totalsize = td1.numFields() + td2.numFields(), size1 = td1.numFields(), i=0;
        ...
        TupleDesc ans = new Tupledesc(TypeAr, NameAr);
        return ans;
    }
